        ...
        <div class="">
          <div class="content-wrapper ">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hi, welcome {{$name}}!</h3>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div style="position: absolute; top: 30px;  left: 600px;" class="col-sm-5 text-md-end">
                          <button type="button" title="Add new document" class="btn btn-icon-text mb-3 mb-sm-0 btn-inverse-primary font-weight-normal" onclick="window.location.href='/uploadfilesUser'">
